...
exports.sendReturnNotification = sendReturnNotification;
...
async function sendMail(to, subject, html) {
    ...
    try {
        ...
        (0, loggerService_1.logError)(error, { recipient: to, subject, operation: 'sendMail' });
        return false;
    }
}
// Send invitation link to parent
async function sendInvitationEmail(parentEmail, childName, activationUrl, code) {
...
async function sendReturnNotification(parentEmail, childName, returnNote) {
...
async function sendApprovalNotification(parentEmail, childName) {
