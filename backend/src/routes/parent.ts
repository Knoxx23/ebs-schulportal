...
router.put('/case', requireParentSession, async (req: AuthRequest, res: Response) => {
  ...
  const {
    ...
    guardian_1_street, guardian_1_zip, guardian_1_city, guardian_1_phone,
    guardian_2_last_name, guardian_2_first_name, guardian_2_birth_country,
    guardian_2_street, guardian_2_zip, guardian_2_city, guardian_2_phone,
    kindergarten, enrollment_year, transition_year, enrollment_date,
  ...
  `).run(
    ...
    guardian_1_street || null, guardian_1_zip || null, guardian_1_city || null, guardian_1_phone || null,
    guardian_2_last_name || null, guardian_2_first_name || null, guardian_2_birth_country || null,
    guardian_2_street || null, guardian_2_zip || null, guardian_2_city || null, guardian_2_phone || null,
    kindergarten || null, enrollment_year || null, transition_year || null, enrollment_date || null,
...
function sanitizeCaseForParent(c: any) {
  return {
    ...
    guardian_1_street: c.guardian_1_street,
    guardian_1_zip: c.guardian_1_zip,
    guardian_1_city: c.guardian_1_city,
    guardian_1_phone: c.guardian_1_phone,
    ...
    guardian_2_street: c.guardian_2_street,
    guardian_2_zip: c.guardian_2_zip,
    guardian_2_city: c.guardian_2_city,
    guardian_2_phone: c.guardian_2_phone,
    kindergarten: c.kindergarten,
    enrollment_year: c.enrollment_year,
    transition_year: c.transition_year,
